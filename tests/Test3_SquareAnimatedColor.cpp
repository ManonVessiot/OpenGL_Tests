#include "Test3_SquareAnimatedColor.h"
...
namespace tests {
    ...
    Test3_SquareAnimatedColor::Test3_SquareAnimatedColor()
    ...
    void Test3_SquareAnimatedColor::OnUpdate(float deltaTime)
    {    
    }

    void Test3_SquareAnimatedColor::OnRender(){
    ...
    void Test3_SquareAnimatedColor::OnImGuiRender()
    {
    }

    void Test3_SquareAnimatedColor::updateColor(){    
        if (m_R > 1.0f){
            m_IncrementR *= -1;
        }
        else if (m_R < 0.0f){
