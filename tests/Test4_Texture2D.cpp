...
namespace tests {
    ...
    Test4_Texture2D::Test4_Texture2D()
    ...
    void Test4_Texture2D::OnUpdate(float deltaTime)
    {    
    }

    void Test4_Texture2D::OnRender(){
    ...
    void Test4_Texture2D::OnImGuiRender()
    {
    }

    void Test4_Texture2D::updateColor(){    
        if (m_R > 1.0f){
            m_IncrementR *= -1;
        }
        else if (m_R < 0.0f){
