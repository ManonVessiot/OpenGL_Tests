...
namespace tests {
    Test10_Material::Test10_Material()
    ...
    void Test10_Material::OnUpdate(float deltaTime)
    {
    ...
    void Test10_Material::OnImGuiRender()
    {
