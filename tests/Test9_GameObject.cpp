...
namespace tests {
    Test9_GameObject::Test9_GameObject()
    ...
    void Test9_GameObject::OnUpdate(float deltaTime)
    {
    ...
    void Test9_GameObject::OnRender()
    {
    ...
    void Test9_GameObject::OnImGuiRender()
    {
